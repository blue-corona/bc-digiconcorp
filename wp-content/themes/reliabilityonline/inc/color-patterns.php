<?php
/**
 * Reliability Online: Color Patterns
 *
 * @package WordPress
 * @subpackage ReliabilityOnline
 * @since 1.0
 */
 ...
 */
function reliabilityonline_custom_colors_css() {
	...
	/**
	 * Filter Reliability Online default saturation level.
	 *
	 * @since Reliability Online 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'reliabilityonline_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Reliability Online default selection saturation level.
	 *
	 * @since Reliability Online 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'reliabilityonline_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Reliability Online default lightness level.
	 *
	 * @since Reliability Online 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'reliabilityonline_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Reliability Online default hover lightness level.
	 *
	 * @since Reliability Online 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'reliabilityonline_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Reliability Online default selection lightness level.
	 *
	 * @since Reliability Online 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'reliabilityonline_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Reliability Online custom colors CSS.
	 *
	 * @since Reliability Online 1.0
	 *
	 ...
	 */
	return apply_filters( 'reliabilityonline_custom_colors_css', $theme_css, $primary_color, $saturation );
}
